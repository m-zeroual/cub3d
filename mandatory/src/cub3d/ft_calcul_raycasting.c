...
/*   Updated: 2023/08/15 14:59:09 by mzeroual         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./../../../include/cub3d.h"

static void	check_wall_h(t_cub3d *_cub3d, int check)
{
...
double	ft_calcul_h(t_cub3d *_cub3d, int *is_door)
{
	...
	check_wall_h(_cub3d, check);
	return (vetagorc(_cub3d->horizontal.x, _cub3d->horizontal.y \
, _cub3d->px, _cub3d->py));
}

static void	check_wall_v(t_cub3d *_cub3d, int check)
{
